function exam(input){
    ...
    console.log(`Top students: ${topStudentsCountP.toFixed(2)}%`);
    console.log(`Between 4.00 and 4.99: ${between4And5CountP.toFixed(2)}%`);
    console.log(`Between 3.00 and 3.99: ${betwen3And4CountP.toFixed(2)}%`);
    console.log(`Fail: ${failGradeCountP.toFixed(2)}%`);
